...
| [docs/DESIGN_GAP_AND_SPECS.md](docs/DESIGN_GAP_AND_SPECS.md) | The pen.dev design against what is built: what the API already supports, what needs building first (with specs), and what the design omits. |
