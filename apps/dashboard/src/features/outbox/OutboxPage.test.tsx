...
describe('OutboxPage', () => {
  it('lists PARKED entries by default and says what parked means before the table', () => {
     ...
     * ONE per row.
     *
     * `Table` has a card rendering for phones, but exactly one of the two is
     * ever in the document — see `useMediaQuery`. Static markup gets the
     * desktop branch, which is the dominant case and the one every other
