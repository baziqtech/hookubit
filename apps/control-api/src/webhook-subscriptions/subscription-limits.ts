 ...
 * Subscriptions are the FAN-OUT MULTIPLIER: the router materialises one
 ...
 * directly - "materialised fan-out is cheap at 10 subscribers and expensive at
...
export const SUBSCRIPTIONS_PER_PROJECT = {
   ...
   * five hundred is far past both and still a fan-out a single event can afford.
   */
  default: 500,
  min: 1,
  max: 10_000,
 ...
 * back - refusing to boot over a fan-out ceiling would be the worse failure.
 */
